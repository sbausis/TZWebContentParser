...
- (id)init {
    ...
    if (self) {
        _knownPages = [NSArray arrayWithObjects:
                      ...
                      [NSArray arrayWithObjects:@"https://kickass.so", [TZ_kickass_PageParser class], nil],
                      [NSArray arrayWithObjects:@"http://katproxy.com", [TZ_kickass_PageParser class], nil],
                      ...
                      [NSArray arrayWithObjects:@"https://thepiratebay.se", [TZ_thepiratebay_PageParser class], nil],
                      ...
                      [NSArray arrayWithObjects:@"http://1337x.to", [TZ_1337x_PageParser class], nil],
                      ...
                      [NSArray arrayWithObjects:@"https://rarbg.com", [TZ_rarbg_PageParser class], nil],
